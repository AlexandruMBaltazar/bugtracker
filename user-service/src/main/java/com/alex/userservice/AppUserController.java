...
public record AppUserController(AppUserService appUserService) {
    ...
    public ResponseEntity<AppUserResponseDto> getAppUserByEmail(@PathVariable String email) {
        AppUserResponseDto appUserResponseDto = appUserService.getAppUserByEmail(email);
